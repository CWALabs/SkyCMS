...
Note: Cloudflare R2 uses a custom S3 endpoint (eg. `https://{account-id}.r2.cloudflarestorage.com`). For guidance on credentials and endpoint information, see [Cloudflare R2 access keys for SkyCMS](./Cloudflare-R2-AccessKeys.md).
