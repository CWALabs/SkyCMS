...
/// <paramref name="userId"/> (typically mapped to <see cref="AuthorInfo.Id"/> as a string).
...
/// <paramref name="userId"/> should not create duplicate author records. Any required
