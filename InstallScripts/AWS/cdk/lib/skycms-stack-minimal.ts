...
export class SkyCmsEditorStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: SkyCmsProps) {
    ...
    let sesSecret: secretsmanager.Secret | undefined;
    ...
    if (sesEnabled) {
      ...
      const sesAccessKeys = new AccessKeyGenerator(this, 'SesAccessKeys', {
      ...
      containerSecrets.SmtpEmailProviderOptions__Password = ecs.Secret.fromSecretsManager(
        sesSecret,
        'password'
      );
    }
